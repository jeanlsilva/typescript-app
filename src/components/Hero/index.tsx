    ...
    return (
        <HeroSection id="hero">
            ...
            <Container>
                ...
                <BulletWrapper>
                    <Bullet className="selected" onClick={(e: BaseSyntheticEvent) => handleChangeSlide(e, 'item-1')} />
                    <Bullet ref={bulletRef} onClick={(e: BaseSyntheticEvent) => handleChangeSlide(e, 'item-2')} />
                    <Bullet ref={bulletRef} onClick={(e: BaseSyntheticEvent) => handleChangeSlide(e, 'item-3')} />
                </BulletWrapper>
            </Container>
        </HeroSection>
    )
